...
import { base64ToUint8Array, decodeUint8ArrayTx, uint8ArrayToBase64 } from "../../utils/tx.utils";
  ...
  const getSignedTx = async (tx: Uint8Array | QubicTransaction): Promise<{ tx: Uint8Array }> => {
    ...
    switch (wallet.connectType) {
      ...
      case "walletconnect": {
        ...
        // Get identities from the decoded transaction
        ...
        // Use the wallet's publicKey as 'from' to ensure WalletConnect uses the correct address
        // WalletConnect will validate and use the connected wallet's address
